      ...
      <header className="w-full mt-13 max-w-7xl flex justify-between items-center mb-10">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <svg
              className="w-6 h-6 text-gray-300 absolute left-3 top-1/2 transform -translate-y-1/2"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <section className="lg:col-span-2 backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            {recentActivities.map((activity) => (
              <div
                key={activity.id}
                className="flex items-start p-4 hover:bg-white/5 rounded-xl transition-colors"
              >
                <div
