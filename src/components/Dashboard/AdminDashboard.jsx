...
const AdminDashboard = () => {
  ...
  const [users, setUsers] = useState([
    { id: "u1", name: "John Doe", email: "john@diu.edu", role: "Member", status: "Active", joinedAt: "2025-06-10" },
    { id: "u2", name: "Jane Smith", email: "jane@diu.edu", role: "Moderator", status: "Active", joinedAt: "2025-06-12" },
    { id: "u3", name: "Rahim U.", email: "rahim@diu.edu", role: "Member", status: "Banned", joinedAt: "2025-07-01" },
  ]);
  const [events, setEvents] = useState([
    { id: "e1", title: "Hackathon 2025", date: "2025-08-20", status: "Pending", location: "DIU Auditorium", published: false },
    { id: "e2", title: "React Workshop", date: "2025-08-25", status: "Approved", location: "Lab-1", published: true },
    { id: "e3", title: "AI Seminar", date: "2025-09-03", status: "Rejected", location: "Conference Hall", published: false },
  ]);
